...
/***/ "./src/app/layout/books/books-routing.module.ts":
/*!******************************************************!*\
  !*** ./src/app/layout/books/books-routing.module.ts ***!
  \******************************************************/
...
/* harmony import */ var _books_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./books.component */ "./src/app/layout/books/books.component.ts");
...
/***/ "./src/app/layout/books/books.component.html":
/*!***************************************************!*\
  !*** ./src/app/layout/books/books.component.html ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = ".hide {\n  display: none; }\n\n.ng2-smart-action .ng2-smart-action-add-add .ng-star-inserted {\n  display: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/books/books.component.ts":
/*!*************************************************!*\
  !*** ./src/app/layout/books/books.component.ts ***!
  \*************************************************/
...
var BooksComponent = /** @class */ (function () {
    function BooksComponent(bookservice, userService) {
        this.bookservice = bookservice;
        this.userService = userService;
        this.books = [];
        this.checkval = false;
    }
    BooksComponent.prototype.getDemoData = function () {
        var data;
        return data;
    };
    BooksComponent.prototype.ngOnInit = function () {
        ...
        this.bookservice.GetAllISBNDetails().subscribe(function (booklist) {
    ...
    BooksComponent.prototype.onSearchClear = function () {
        this.searchKey = '';
    };
    ...
    BooksComponent.prototype.deleteBook = function (book) {
        ...
        if (window.confirm('Do u want to delete?')) {
            this.bookservice.deleteBook(book).subscribe(function (data) {
                if (data) {
                    var i = _this.books.findIndex(function (e) { return e.TrackNo === book.TrackNo; });
                    if (i !== -1) {
    ...
    BooksComponent.prototype.editBook = function (book) {
        ...
        this.bookservice.editBook(book).subscribe(function (data) {
        }, function (error) { console.log(error); });
    };
    BooksComponent.prototype.backToBook = function (book) {
        if (window.confirm('Do u want to delete?')) {
        }
    };
    BooksComponent.prototype.BlockBook = function (isbn) {
        if (window.confirm('Do u want to delete?')) {
            if (this.configValue.BookBlockLimit > this.currentUser.BlockedCopies) {
                this.userService.BlockBook(isbn).subscribe(function (data) {
                    if (data === true) {
                        isbn.Occupied = true;
                    }
                });
    ...
    BooksComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-tables',
            template: __webpack_require__(/*! ./books.component.html */ "./src/app/layout/books/books.component.html"),
            animations: [Object(_router_animations__WEBPACK_IMPORTED_MODULE_1__["routerTransition"])()],
            styles: [__webpack_require__(/*! ./books.component.scss */ "./src/app/layout/books/books.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_book_service__WEBPACK_IMPORTED_MODULE_2__["BookService"], src_app_shared_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"]])
    ], BooksComponent);
...
/***/ "./src/app/layout/books/books.module.ts":
/*!**********************************************!*\
  !*** ./src/app/layout/books/books.module.ts ***!
  \**********************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _books_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./books-routing.module */ "./src/app/layout/books/books-routing.module.ts");
/* harmony import */ var _books_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./books.component */ "./src/app/layout/books/books.component.ts");
...
var BooksModule = /** @class */ (function () {
    ...
    BooksModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _books_routing_module__WEBPACK_IMPORTED_MODULE_2__["BooksRoutingModule"], _shared__WEBPACK_IMPORTED_MODULE_4__["PageHeaderModule"],
